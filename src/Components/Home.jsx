...
function Home() {
   ...
   useEffect(() => {
     if (inView6) {
      ...
      Reminder4.start({ opacity: 1, transition: { duration: 4, delay: 1} });
      Reminder5.start({ opacity: 1, transition: { duration: 4, delay: 1.8} });
      Reminder6.start({ opacity: 1, transition: { duration: 4, delay: 2.6} });
      Reminder7.start({ opacity: 1, transition: { duration: 4, delay: 3.4} });
     }
