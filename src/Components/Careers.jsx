    ...
    <div className='h-[430vh] w-auto'>
        ...
        <div className='flex items-center justify-around'>
             ...
             <motion.h1
               ...
               animate={Hero1}
               ref={ref2}   
             className='mb-12 text-lg mt-16 tracking-widest'>DATA SCIENTIST</motion.h1>
                     <motion.h4
                      initial={{opacity: 0, x : -35}}
                      animate={Hero2}
                      ref={ref2}  
                     className='text-sm opacity-70 tracking-widest'>Silicon Valley</motion.h4>
                     <motion.p
                       initial={{opacity: 0, x : -35}}
                       animate={Hero3}
                       ref={ref2}   
                     className='mt-5 home-line1'>I'm a paragraph. Click here to add your <br /> own text and edit me. It’s easy. Just <br /> click “Edit Text” or double click me to <br /> add your own content and make <br /> changes to the font. </motion.p>
                     <motion.button
                     initial={{opacity: 0,}}
                     animate={Hero7}
                     ref={ref2}    
                     className='px-6 mt-10 py-2 hover:bg-white hover:text-black duration-500 border rounded-md'>Apply Now <span><MdArrowForward className='inline-block' /></span></motion.button>
             </div>
             ...
             <motion.h1
                ...
                animate={Hero4}
                ref={ref2} 
             className='mb-12 text-lg mt-16 tracking-widest'>ELECTRICAL ENGINEER</motion.h1>
                     <motion.h4
                      initial={{opacity: 0, x : 35}}
                      animate={Hero5}
                      ref={ref2}  
                     className='text-sm opacity-70 tracking-widest'>San Francisco, CA</motion.h4>
                     <motion.p
                        initial={{opacity: 0, x : 35}}
                        animate={Hero6}
                        ref={ref2} 
        ...
        <div className='flex mt-24 items-center justify-around'>
             ...
             <motion.h1
              ...
              animate={A1}
              ref={ref3}  
             className='mb-12 text-lg mt-16 tracking-widest'>ARTIFICIAL INTELLIGENCE <br /> RESEARCHER</motion.h1>
                     <motion.h4
                      initial={{opacity: 0, x : -35}}
                      animate={A2}
                      ref={ref3}   
                     ...
                     <motion.p
                      ...
                      animate={A3}
                      ref={ref3}   
                     className='mt-5 home-line1'>I'm a paragraph. Click here to add your <br /> own text and edit me. It’s easy. Just <br /> click “Edit Text” or double click me to <br /> add your own content and make <br />  </motion.p>
                     <motion.button 
                      initial={{opacity: 0,}}
                      animate={A7}
                      ref={ref3}  
             ...
             <motion.h1
               ...
               animate={A4}
               ref={ref3}  
             className='mb-12 text-lg mt-16 tracking-widest'>DEEP LEARNING ENGINEER</motion.h1>
                     <motion.h4
                      initial={{opacity: 0, x : 35}}
                      animate={A5}
                      ref={ref3}  
